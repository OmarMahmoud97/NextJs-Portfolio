...
function Thankyou() {
  return (
    <div className="thanks flex-col h-screen justify-center items-center flex text-white">
      <p className="textshadow lg:text-7xl text-5xl mb-6">Thank You</p>
      <p className="textshadow lg:text-3xl text-2xl mb-10">
        Email Succesfully Sent
      </p>
      <p className="textshadow lg:text-2xl text-1xl mb-10">
